...
const AVATARS = {
  ...
  bajie:    { name:'Zhu Bajie',       title:'Marshal of the Canopy',      emoji:'🌸', img:'black_myth_wukong/bajie.jpg',   color:'#8b3a3a' },
...
const QUOTES = {
  victory: [
    ...
    '"The Dao favors the unyielding."',
    '"Even immortals would kneel before this triumph."',
    '"Your spirit burns brighter than the celestial forge."',
    '"You have carved your legend into eternity."',
    '"Victory is but a shadow of your true power."'
  ],
  defeat: [
    ...
    '"Ashes today, legend tomorrow."',
    '"Your spirit falters, but it is not broken."',
    '"Even fallen stars may rise again."',
    '"Defeat tempers the blade of the soul."',
    '"The path to immortality is paved with failure."',
    '"Silence now… but storms will follow."'
  ],
  draw: [
    '"Two immovable forces — the earth itself has cracked."',
    '"When equal spirits clash, the universe holds its breath."',
    '"No victor, no vanquished — only balance remains."',
    '"Yin meets Yang, and neither yields."',
    '"The heavens pause, unable to judge this clash."',
    '"A battle without end, written in eternity."',
    '"Both flames burn — neither fades."'
  ]
};
